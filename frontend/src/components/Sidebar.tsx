  ...
  return (
    <aside className="sidebar">
      ...
      <div className="nav-section">
        ...
        <Link href="/live-activity" className={`nav-item ${navActive('/live-activity') ? 'active' : ''}`}>
        ...
        <Link href="/incidents" className={`nav-item ${navActive('/incidents') ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
          Incidents
        </Link>
        <Link href="/playbooks" className={`nav-item ${navActive('/playbooks') ? 'active' : ''}`}>
        ...
        <Link href="/hunt" className={`nav-item ${navActive('/hunt') ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/><path d="M11 8v3l2 2"/></svg>
          Threat Hunt
        </Link>
        <Link href="/reports" className={`nav-item ${navActive('/reports') ? 'active' : ''}`}>
        ...
        <Link href="/threat-intel" className={`nav-item ${navActive('/threat-intel') ? 'active' : ''}`}>
        ...
        <Link href="/agents" className={`nav-item ${navActive('/agents') ? 'active' : ''}`}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/><circle cx="12" cy="10" r="2"/></svg>
          Agents
        </Link>
        {isAdmin && (
          <Link href="/settings" className={`nav-item ${navActive('/settings') ? 'active' : ''}`}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93l-1.41 1.41M4.93 4.93l1.41 1.41M19.07 19.07l-1.41-1.41M4.93 19.07l1.41-1.41M21 12h-2M5 12H3M12 21v-2M12 5V3"/></svg>
            Settings
          </Link>
        )}
      </div>
      ...
      <div className="sidebar-footer">
        <div className="user-row" onClick={logout} title="Click to logout">
          ...
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} width={14} height={14} style={{ color: 'var(--text-muted)' }}><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>
        </div>
      </div>
    </aside>
  );
